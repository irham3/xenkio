...
import { useDiffChecker } from '@/features/diff-checker/hooks/use-diff-checker';
import { DIFF_TYPES, VIEW_MODES, SAMPLE_ORIGINAL, SAMPLE_MODIFIED } from '@/features/diff-checker/constants';
import { DiffType } from '@/features/diff-checker/types';
