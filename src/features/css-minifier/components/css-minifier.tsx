...
import { useCssMinifier } from '../hooks/use-css-minifier';
import { INDENT_SIZES, SAMPLE_CSS } from '../constants';
...
export function CssMinifier() {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = activeTab === 'minify' ? 'minified.css' : 'beautified.css';
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-baseline justify-between">
                  <Label htmlFor="css-input" className="text-sm font-semibold text-gray-800">
                    CSS Input
                  </Label>
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-gray-400 font-medium tabular-nums">
                      {options.css.length.toLocaleString()} chars
                    </span>
                    <button
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  ...
                  disabled={isProcessing || !options.css.trim()}
            ...
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-semibold text-gray-800">
                  {activeTab === 'minify' ? 'Minified CSS' : 'Beautified CSS'}
                </h3>
                <div className="flex items-center gap-2">
