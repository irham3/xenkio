...
import { useJsMinifier } from '../hooks/use-js-minifier';
import { INDENT_SIZES, SAMPLE_JS } from '../constants';
...
export function JsMinifier() {
  ...
  const [activeTab, setActiveTab] = useState<TabMode>('minify');
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = activeTab === 'minify' ? 'minified.js' : 'beautified.js';
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-baseline justify-between">
                  <Label htmlFor="js-input" className="text-sm font-semibold text-gray-800">
                    JavaScript Input
                  </Label>
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-gray-400 font-medium tabular-nums">
                      {options.js.length.toLocaleString()} chars
                    </span>
                    <button
                      onClick={() => loadSample(SAMPLE_JS)}
                ...
                <textarea
                  id="js-input"
                  value={options.js}
                  onChange={(e) => updateOption('js', e.target.value)}
              ...
              <div className="flex gap-2 pt-2">
                <Button
                  ...
                  disabled={isProcessing || !options.js.trim()}
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      {activeTab === 'minify' ? 'Minify JS' : 'Beautify JS'}
                    </>
                  )}
                </Button>
                <Button
            ...
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-semibold text-gray-800">
                  {activeTab === 'minify' ? 'Minified JS' : 'Beautified JS'}
                </h3>
                <div className="flex items-center gap-2">
                ...
                <div className={cn(
                  ...
                  {isProcessing ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full gap-2 opacity-50">
                      ...
                      <p className="font-sans">Paste JavaScript and click {activeTab === 'minify' ? 'Minify' : 'Beautify'}...</p>
                    </div>
                  )}
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-semibold text-gray-700">{stats.resultLines} lines</p>
                    </div>
                    <div className="text-center">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-semibold text-gray-700">{(stats.resultSize / 1024).toFixed(2)} KB</p>
                    </div>
                  </div>
                </div>
              )}
