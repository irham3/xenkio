...
import { UploadSimple, DownloadSimple, FileVideo, Sliders, Image as ImageIcon, WarningCircle, ArrowsClockwise, Play, Pause, Scissors, SpinnerGap } from '@phosphor-icons/react/dist/ssr';
            ...
            {isConverting && (
                <div className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm">
                    <div className="flex items-center gap-3">
                        <SpinnerGap className="w-5 h-5 text-primary-600 animate-spin shrink-0" />
                ...
                <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                    <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/80 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <ImageIcon className="w-4 h-4 text-emerald-500" aria-hidden="true" />
